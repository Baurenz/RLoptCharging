...
from solvers.train.custom_callbacks import CustomMetricsCallback
...
env = gym.make('CsEnv-v0', price=0, simnet=0, solar=1, pp_network_path=pp_network_path, network_config_path=network_config_path,
