...
base_models_dir = Path("../models/PPO")
base_logdir = Path("../results/logs/PPO")
...
env = gym.make(args.env, price=args.price, simnet=args.simnet, solar=args.solar,
               ...
               use_irradiance=args.use_irradiance)
...
for i in range(1, 50):
    ...
    create_profiles.create_new_profiles(network_config_path, args.use_irradiance)
